...
INSERT INTO TEAM VALUES
    -- Eastern Conference
    ('Atlanta Hawks', 'ATL', 9, 8, 11, 1, 'East'),
    ('Boston Celtics', 'BOS', 2, 15, 3, 18, 'East'),
    ('Brooklyn Nets', 'BKN', 8, 9, 10, 0, 'East'),
    ('Charlotte Hornets', 'CHA', 12, 6, 12, 0, 'East'),
    ('Chicago Bulls', 'CHI', 10, 8, 12, 6, 'East'),
    ('Cleveland Cavaliers', 'CLE', 1, 17, 2, 1, 'East'),
    ('Detroit Pistons', 'DET', 11, 8, 12, 3, 'East'),
    ('Indiana Pacers', 'IND', 7, 9, 10, 0, 'East'),
    ('Miami Heat', 'MIA', 6, 8, 8, 3, 'East'),
    ('Milwaukee Bucks', 'MIL', 5, 9, 9, 2, 'East'),
    ('New York Knicks', 'NYK', 4, 10, 8, 2, 'East'),
    ('Orlando Magic', 'ORL', 3, 13, 7, 0, 'East'),
    ('Philadelphia 76ers', 'PHI', 14, 3, 14, 3, 'East'),
    ('Toronto Raptors', 'TOR', 13, 5, 14, 1, 'East'),
    ('Washington Wizards', 'WAS', 15, 2, 15, 1, 'East'),
    -- Western Conference
    ('Dallas Mavericks', 'DAL', 8, 11, 8, 1, 'West'),
    ('Denver Nuggets', 'DEN', 7, 10, 7, 1, 'West'),
    ('Golden State Warriors', 'GSW', 3, 12, 6, 7, 'West'),
    ('Houston Rockets', 'HOU', 2, 14, 6, 2, 'West'),
    ('Los Angeles Clippers', 'LAC', 6, 12, 8, 0, 'West'),
    ('Los Angeles Lakers', 'LAL', 5, 11, 7, 17, 'West'),
    ('Memphis Grizzlies', 'MEM', 4, 12, 7, 0, 'West'),
    ('Minnesota Timberwolves','MIN', 12, 8, 10, 0, 'West'),
    ('New Orleans Pelicans', 'NOP', 15, 4, 15, 0, 'West'),
    ('Oklahoma City Thunder', 'OKC', 1, 14, 4, 1, 'West'),
    ('Phoenix Suns', 'PHX', 9, 10, 8, 0, 'West'),
    ('Portland Trail Blazers','POR', 13, 7, 12, 1, 'West'),
    ('Sacramento Kings', 'SAC', 11, 9, 10, 1, 'West'),
    ('San Antonio Spurs', 'SAS', 10, 10, 9, 5, 'West'),
    ('Utah Jazz', 'UTA', 14, 4, 14, 0, 'West');
...
-- Atlanta Hawks
    ...
    (15, 'Clint Capella', 'C', 11, 7, 1, '0.66', 'ATL'),
-- Boston Celtics
